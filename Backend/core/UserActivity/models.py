...
#     admin = models.ForeignKey(BaseUserModel, limit_choices_to={'role': 'admin'},on_delete=models.CASCADE)
#     organization = models.ForeignKey(BaseUserModel, limit_choices_to={'role': 'organization'},on_delete=models.CASCADE)
