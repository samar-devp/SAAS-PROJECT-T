        ...
        <div className="modal-body">
          <form >
            ...
            <div className="modal-btn">
              ...
              <Link to={routes.countries} className="btn btn-primary">Create</Link>
            </div>
          </form>
        </div>
      </div>
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          <form >
            ...
            <div className="modal-btn">
              <Link to="#" className="btn btn-light" data-bs-dismiss="modal">Cancel</Link>
              <Link to="#" className="btn btn-primary" data-bs-dismiss="modal">Save Changes</Link>
            </div>
          </form>
        </div>
      </div>
        ...
        <div className="modal-body">
          <div className="success-message text-center">
            ...
            <div className="col-lg-12 text-center modal-btn">
              <Link to="#" className="btn btn-light" data-bs-dismiss="modal">Cancel</Link>
              <Link to="#" className="btn btn-danger" data-bs-dismiss="modal">Yes, Delete it</Link>
            </div>
          </div>
        </div>
      </div>
